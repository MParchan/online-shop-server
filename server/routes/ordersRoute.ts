...
router.route("/admin/all").get(validateToken, isAdmin, getAllOrders);
router.route("/admin/:id/details").get(validateId, validateToken, isAdmin, getOrderDetails);
router.route("/admin/:id/status").patch(validateId, validateToken, isAdmin, changeOrderStatus);
